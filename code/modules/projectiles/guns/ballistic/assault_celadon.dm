/obj/item/gun/ballistic/automatic/assault/g36sh
	...
	icon = 'icons/obj/guns/48x32guns_celadon.dmi'
	lefthand_file = 'icons/mob/inhands/weapons/guns_lefthand_celadon.dmi'
	righthand_file = 'icons/mob/inhands/weapons/guns_righthand_celadon.dmi'
