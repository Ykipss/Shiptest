/obj/item/bong
	...
	icon = 'code/modules/bongs/icons/bong.dmi'
	lefthand_file = 'code/modules/bongs/icons/lefthand.dmi'
	righthand_file = 'code/modules/bongs/icons/righthand.dmi'
	icon_state = "bongoff"
...
/obj/item/bong/attackby(obj/item/used_item, mob/user, params)
	...
	else if(istype(used_item, /obj/item/reagent_containers/glass/bottle)) //for hash/dabs
		if(packed_item)
			balloon_alert(user, "already packed!")
			return
...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	playsound(src, 'code/modules/bongs/sound/heatdam.ogg', 50, TRUE)
	if(!do_after(user, 40))
		return
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('code/modules/bongs/sound/lungbust_moan1.ogg','code/modules/bongs/sound/lungbust_moan2.ogg', 'code/modules/bongs/sound/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('code/modules/bongs/sound/lungbust_cough1.ogg','code/modules/bongs/sound/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
